...
describe('Chai tests.', function() {
    it('Test unordered array deep equal', function(done) {
        expect({array: [{it:'one'}, {it:'two'}]})
            .to.deep.equal({array: [{it:'two'}, {it:'one'}]});
        done();
    });

    it('Test unordered array deep have members', function(done) {
        expect([{it:'one'}, {it:'two'}])
            .to.deep.have.members([{it:'two'}, {it:'one'}]);
        done();
    });
});
...
describe('View Proposal Examples', function() {
    describe('Example Set 1', function() {
        ...
        it('Question 1.1: returning a resource' +
            ' \'un-messed-around-with\'', function(done) {
            request
    ...
    describe('Example Set 2', function() {
        ...
        before(function(done) {
            ...
            var uploadedField = function(field) {
    ...
    describe('Example Set 3 - Advanced cases', function() {
        ...
        it('Question 3.2: turning off a key you are filtering' +
            ' on (the $view keyword)');
